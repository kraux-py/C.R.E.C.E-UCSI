    ...
    <footer id="contacto" className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mt-4">
              Trabajando juntos para construir una universidad más inclusiva, innovadora y centrada en los estudiantes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">
                ...
                Universidad Catolica Nuestra Señora de la Asuncion 'San Ignacio Guazu'
              </li>
              <li>
                <button 
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-gray-700 pb-2">Síguenos</h3>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Campaña Universitaria. Todos los derechos reservados.</p>
          <p className="mt-2">
            <a href="#" className="hover:text-gray-400 transition-colors">Política de Privacidad</a> | 
            <a href="#" className="hover:text-gray-400 transition-colors ml-2">Términos de Servicio</a>
          </p>
