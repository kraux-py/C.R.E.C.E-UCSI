...
const Hero = () => {
  return (
    <section
      id="inicio"
      className="flex items-center justify-center relative overflow-hidden pt-16"
      style={{
        background:
          "linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('https://i.imgur.com/lVtaHHH.png') no-repeat center center",
    ...
    >
      <div className="container mx-auto px-4 md:px-8 py-20 text-center text-white">
        <div className="max-w-4xl mx-auto">
          <h1
            className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 leading-tight animate-fade-in"
          ...
          <p
            className="text-xl md:text-2xl mb-12 opacity-90 animate-fade-in animation-delay-300"
